package lib.world.blocks.distribution;
...
public class CoveredConveyor extends Conveyor {
    ...
    public class FloatingConveyorBuild extends ConveyorBuild{
        ...
        public void onProximityUpdate(){
            ...
            Building backB = back();
            backCap = blendbits == 1 || blendbits == 4 || LibUtls.relativeDirection(backB, this) == 0 && backB.block == block;

            Building leftB = left();
            leftCap = blendbits != 0 && LibUtls.relativeDirection(leftB, this) == 0 && leftB.block != block;

            Building rightB = right();
            rightCap = blendbits != 0 && LibUtls.relativeDirection(rightB, this) == 0 && rightB.block != block;
        }
    }
}
